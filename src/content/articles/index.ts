...
export const articleIndex: Article[] = [
  ...
  },
  {
    ...
    date: "2026-02-10",
    readTime: "5 min",
    image: "/images/madrid/too-good.jpg",
  },
  {
    slug: "death-of-the-dj-bar",
    title: "The Death of the DJ Bar",
    subtitle: "And why nobody's mourning",
    excerpt:
      "Once upon a time, every city had a bar where the DJ mattered more than the drinks menu. Where the queue formed because someone was spinning, not because a cocktail went viral on TikTok.",
    city: "London",
    category: "Sound",
    author: "Wills Mayani",
    date: "2026-02-08",
    readTime: "7 min",
    image: "/images/london/dj-bar.jpg",
  },
  {
    slug: "virgil-was-right",
    title: "Virgil Was Right",
    subtitle: "Three years later, his vision for streetwear is everywhere",
    excerpt:
      "He said the next wave would be about craft, not hype. About community, not drops. Three years after his passing, every brand is finally catching up.",
    city: "London",
    category: "Threads",
    author: "Wills Mayani",
    date: "2026-02-06",
    readTime: "8 min",
    image: "/images/london/virgil.jpg",
  },
  {
