...
export const metadata: Metadata = {
  ...
  description: "Street pieces, photocopied flyers, backroom shows, scruffy brilliance and art that lives outside the gallery system.",
...
export default function ArtPage() {
  const articles = articleIndex; // later: filter to art, flyers, visuals

  return (
    <>
      <div aria-hidden="true" style={{position:"absolute",width:1,height:1,overflow:"hidden",clip:"rect(0,0,0,0)",whiteSpace:"nowrap"}}>
        <h1>Art — Street Pieces, Backroom Shows and Scruffy Brilliance</h1>
        <p>Street pieces, photocopied flyers, backroom shows, scruffy brilliance and art that lives outside the gallery system.</p>
        <nav>
          <a href="/">Home</a>
    ...
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mb-6 text-sm text-neutral-800">
        Street pieces, photocopied flyers, backroom shows, scruffy brilliance.
      </p>
